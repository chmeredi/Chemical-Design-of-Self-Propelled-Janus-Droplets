function [x0,y0,iout,jout] = intersectionsCalc(x1,y1,x2,y2,robust)
%INTERSECTIONSCALC Intersections of curves.
%   Computes the (x,y) locations where two curves intersect.  The curves
%   can be broken with NaNs or have vertical segments.
%
% Example:
%   [X0,Y0] = intersectionsCalc(X1,Y1,X2,Y2,ROBUST);
%
...
%
%   [X0,Y0,I,J] = intersectionsCalc(X1,Y1,X2,Y2,ROBUST);
%
...
% only one curve, i.e.,
%
%   [X0,Y0] = intersectionsCalc(X1,Y1,ROBUST);
%
